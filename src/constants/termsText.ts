export const TERMS_AND_CONDITIONS_HTML = `
  ...
  <p class="mb-4">
    The <strong>ABC Launcher dApp</strong> is an online platform that allows users to create, manage, and interact with Augmented Bonding Curves (ABC). An Augmented Bonding Curve is a mathematical model implemented through a smart contract on a blockchain, which automates the pricing and exchange of digital tokens.
  </p>
  <p class="mb-4">
  ...
  <p class="mb-4">
    Through the <strong>ABC Launcher dApp</strong>, users can:
  </p>
  <ul class="list-decimal pl-8 mb-4">
    <li>Create an ABC using the standardized parameter template</li>
    <li>Customize the project token's name, icon, and ticker</li>
    <li>Connect a wallet address that has been verified through the KYC (Know Your Customer) process to launch the ABC.</li>
    <li>Provide a multisig address</li>
    <li>Deploy NFT smart contracts</li>
  </ul>
  <p class="mb-4">
    While the ABC Launcher dApp offers the tools to facilitate these activities, it is your responsibility to understand the associated risks and implications of creating or participating in an Augmented Bonding Curve.
  </p>
  ...
  <h2 class="font-bold text-lg mb-4">3. Use of Technology</h2>
  <p class="mb-4">
  ...
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
    <li>You are at least 18 years old, or the legal age in your jurisdiction, with no legal impediment or incapability, capable of using the Technology and participating in any token distribution.</li>
    <li>You have read and understood the risks of using the Technology, and that you are solely responsible for your actions.</li>
    ...
    <li>You have had the opportunity to take legal, financial, accounting or other advice that you deem appropriate prior to using the Technology.</li>
    <li>You will only use the Technology with legally obtained digital assets that belong to you, and with full legal and beneficial title to any such assets.</li>
    <li>Your access to the Technology may be restricted based on your jurisdiction or geographical location. You must not use the Technology if you are located in or a citizen or resident of any state, country, territory or other jurisdiction in which use of the Technology would be illegal or otherwise violate any applicable law (a "Restricted Territory"). We reserve the right to restrict access to any Restricted Territory and may implement technical controls to prevent access to the Technology from any Restricted Territory, including, but not limited to, Afghanistan, American Samoa, Anguilla, Antigua and Barbuda, Belarus, Bosnia Herzegovina, Central African Republic, Cuba, DR Congo, Ethiopia, Fiji, Guam, Hong Kong, Iran, Iraq, Kosovo, Lebanon, Libya, Mali, Montenegro, Myanmar, Nicaragua, North Korea, North Macedonia, Palau, Panama, Russia, Samoa, Serbia, Somalia, South Sudan, Sudan, Syria, Ukraine, United States, United Kingdom, US Virgin Islands, Vanuatu, Venezuela, Yemen, or any jurisdictions in which the sale of cryptocurrencies are prohibited, restricted or unauthorized in any form or manner whether in full or in part under the laws, regulatory requirements or rules in such jurisdiction; or any state, country, or region that is subject to sanctions enforced by the United States, such as the Specially Designated Nationals and Blocked Persons List (“SDN List”) and Consolidated Sanctions List (“Non-SDN Lists”), the United Kingdom, or the European Union (collectively, “Restricted Territories”);</li>
    <li>You are not a resident of any restricted territory and have not used any technical means including any virtual private network (VPN) or other means to disguise or manipulate your geographical location to access the Technology from a restricted territory; and</li>
    <li>You represent that your access and use of the Technology will fully comply with all applicable laws and regulations, and that you will not access or use the Technology to conduct, promote, or otherwise facilitate any illegal activity.</li>
  </ul>
  <h2 class="font-bold text-lg mb-4">5. Fees, Access & Features</h2>
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
    <li>While access to our Technology is free of charge, certain interactions and transactions incur a fee.</li>
    <li>Third-party network fees, such as gas costs, may apply when using our Technology.</li>
    <li>By using our Technology, you agree to said fees, whoever the receiving entity may be. You acknowledge and agree that the level of the transaction costs may be increased, decreased, or otherwise altered, without notice and at our sole discretion. We take no responsibility for the existence or level of third-party network fees.</li>
    <li>You are responsible for making all necessary arrangements to interact (or continue to interact) with our Technology.</li>
    <li>You agree to ensure that all interactions with our Technology via your wallet are performed in compliance with these Terms and Conditions.</li>
    <li>You acknowledge and agree to abide by any features, mechanisms, rules and parameters in operation on our Technology from time to time, and their consequences.</li>
  </ul>
  ...
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
    ...
    <li>You understand that our Technology and your digital assets could be impacted by one or more regulatory inquiries or regulatory actions, which could impede or limit the ability to continue providing our Technology.</li>
    <li>You acknowledge that the cost of transacting on the blockchain is variable and may increase at any time, causing impact to any activities taking place on the blockchain, which may result in price fluctuations or increased costs when using the Technology.</li>
    <li>You use the Technology at your own risk. You acknowledge that the Technology is subject to flaws and that you are solely responsible for evaluating any code provided in the ABC Launcher dApp interface.</li>
    <li>You acknowledge that the information available in the Technology may not always be entirely accurate, complete, or current and may also include technical inaccuracies or typographical errors. To continue to provide you with as complete and accurate information as possible, information may be changed or updated from time to time without notice, including information regarding our policies. Accordingly, you should verify all information before relying on it, and all decisions based on information contained on or as part of the Technology interface are your sole responsibility. No representation is made as to the accuracy, completeness, or appropriateness for any particular purpose of any information distributed via or otherwise when using the Technology.</li>
    <li>By using the Technology, you represent and warrant that you have been, are, and will be solely responsible for making your independent appraisal and investigations into the risks of a given transaction and the underlying digital assets, including smart contracts. You represent that you have sufficient knowledge, market sophistication, professional advice, and experience to make your evaluation of the merits and risks of any transaction conducted in connection with the Technology or any digital asset.</li>
    <li>You accept all consequences of using the Technology, including the risk that you may lose access to your digital assets indefinitely. All transaction decisions are made solely by you. Notwithstanding anything in these Terms, we accept no responsibility whatsoever for, and will in no circumstances be liable to you in connection with, your use of the Technology for performing digital asset transactions, including entering into smart contracts.</li>
    <li>You hereby acknowledge and agree that we will have no responsibility or liability for the risks set forth in this Section or inherent to the use of the Technology.</li>
    <li>You hereby irrevocably waive, release, and discharge all claims, whether known or unknown to you, against us and our shareholders, members, directors, officers, employees, agents, and representatives, suppliers, and contractors related to any of the risks set forth in this Section or inherent to the use of the Technology.</li>
    <li>You understand and acknowledge that before you use the Technology, you should be familiar with any rules or laws relevant to the Technology provided.</li>
    <li>You should obtain independent advice about the different types of Technology available in both your home jurisdiction and other relevant jurisdictions before you start using the Technology. If your country of residence imposes restrictions on digital assets, we may be required to discontinue your access to the Technology. We may not be permitted to transfer digital assets or permit the transfer of digital assets as a consequence of a judicial or administrative order or regulatory environment.</li>
    <li>You are responsible for all taxes in respect of any gains obtained by using the Technology. Before using our Technology, you should understand the tax implications of acquiring, entering into, holding, and disposing of a digital asset. You should consult your independent tax advisor to understand the relevant tax implications of your activities.</li>
    <li>You understand that the use of the Technology is exposed to regulatory and legal risk, and that the regulatory framework of digital assets may change or vary according to each jurisdiction. The effect of regulatory legal risk may affect the value of any digital asset. The laws of various jurisdictions may apply to digital assets listed in the Technology. Applying these laws and regulations to digital assets is untested, and laws and regulations are subject to change without prior notice. As a result of regulation and legislation around digital assets, the Technology may become or not be available in certain jurisdictions.</li>
    <li>You understand that we have no ability to recover lost credentials or restore lost access to the wallet you use to access our Technology.</li>
  ...
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
    <li>The Technology interface may contain references or links to third-party resources, including, but not limited to, information, materials, products, or Technology that we do not own or control. In addition, third parties may offer promotions related to your access and use of the Technology.</li>
  ...
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
    <li>We own all intellectual property and other rights associated with our Technology, including, but not limited to, software, text, images, trademarks, service marks, copyrights, patents, and designs.</li>
    <li>Any of our names, logos, and other marks used in the Technology as a part of our Technology, are trademarks owned by us, our affiliates or its applicable licensors. You may not copy, imitate or use such trademarks without our, or the applicable licensor's prior written consent.</li>
    <li>You acknowledge that certain aspects of our Technology may use, incorporate or link to certain open-source components and that your use of the Technology is subject to, and you will comply with, any applicable open-source licenses that govern any such open-source components.</li>
    <li>Excluding third-party software that our Technology incorporates, we own the Technology and all portions thereof, including all technology, content and other materials used, displayed or provided on or in connection with the Technology, including all intellectual property rights therein and thereto, whether or not subject to the open-source licenses, and hereby grant you a limited, non-exclusive, revocable, non-transferable, non-sublicensable license to access and use those portions of the Technology that are proprietary and not available pursuant to the open-source licenses.</li>
  ...
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
    <li>The Technology is a non-custodial software application, in which you are the sole responsible for the custody of the cryptographic private keys to the digital assets and wallets you hold to access and use our Technology.</li>
  ...
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
    <li>While using the Technology we may collect some personal data in order to provide our Technology, including your blockchain wallet address, completed transaction hashes and token IDs. We may also use third-party analytics Technology to track your use of the website so we can improve the user experience.</li>
    <li>To comply with AML and KYC regulations, you may be required to provide personal information and documentation. We reserve the right to conduct AML and KYC checks on participants and may refuse participation to anyone who fails to meet the required standards. We use the information we collect to detect, prevent, and mitigate financial crime and other illicit or harmful activities on the Technology. For these purposes, we may share the information we collect with blockchain analytics providers. We share information with these service providers only so that they can help us promote the safety, security, and integrity of the Technology.</li>
    <li>We may use third-party service providers which may receive or independently obtain your personal information from publicly-available sources. By accessing and using the Technology, you understand and consent to our data practices and our service providers' treatment of your information.</li>
  ...
  <h2 class="font-bold text-lg mb-4">12. Disclaimers</h2>
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
    <li>We do not endorse or provide investment advice. The Technology is provided on an "as is" and "as available" basis, without any warranties or guarantees of any kind.</li>
    <li>We shall not be liable for any direct, indirect, incidental, consequential, or exemplary damages arising out of or in connection with your use of the Technology.</li>
  </ul>
  <h2 class="font-bold text-lg mb-4">13. Indemnification</h2>
  <p class="mb-4">
  ...
  <h2 class="font-bold text-lg mb-4">14. Limitation of Liability</h2>
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
  ...
  <h2 class="font-bold text-lg mb-4">15. Release</h2>
  <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 1rem;">
    <li>You expressly agree that you assume all risks concerning your access to and use of the Technology. Additionally, you expressly waive and release us from any liability, claims, causes of action, or damages arising from or in any way relating to your access to and use of the Technology.</li>
    <li>These Terms will survive any termination of your access to the Technology, regardless of the reasons for its expiration or termination, in addition to any other provision which by law or by its nature should survive.</li>
  </ul>
  <h2 class="font-bold text-lg mb-4">16. Breach of Terms & Conditions</h2>
  <p class="mb-4">
...
These Terms and Conditions govern the access and use of the ABC Launcher dApp “abclauncher.giveth.io” developed by Giveth Association (“Association”, “We”, “Our” or “Us”), an association organized and existing under the laws of Zug, Switzerland, and other Services that the Association provides to the Project (“User”, or “You”). 
  
    By accessing or using our Technology, you agree to be bound by the following terms and conditions (the "Terms"). Please read them carefully before participating. If you do not agree with any of the provisions stated herein, you should not use our Technology or participate in any of our initiatives.
  
  1. Services
  
    The ABC Launcher dApp is an online platform that allows users to create, manage, and interact with Augmented Bonding Curves (ABC). An Augmented Bonding Curve is a mathematical model implemented through a smart contract on a blockchain, which automates the pricing and exchange of digital tokens.
  
    By using this platform, you agree to accept a grant valued at approximately 50,000 USD in POL tokens (the “Grant”) that is exclusively allocated for the purpose of launching an ABC on the platform.
  
    Through the ABC Launcher dApp, users can:
  
  
    
• Create an ABC using the standardized parameter template    
• Customize the project token's name, icon, and ticker    
• Connect a wallet address that has been verified through the KYC (Know Your Customer) process to launch the ABC.    
• Provide a multisig address    
...
• You understand that we do not own or control any of the underlying software through which blockchain networks are formed. In general, the software underlying blockchain networks, including the Polygon zkEVM blockchain, is open source, such that anyone can use, copy, modify, and distribute it.    
• 
      By using the Technology, you acknowledge and agree, that:

• We are not responsible for the operation of the blockchain-based software and networks underlying the Technology;        
• There exists no guarantee of the functionality, security, or availability of that software and networks; and        
...
• Excluding third-party software that our Technology incorporates, we own the Technology and all portions thereof, including all technology, content and other materials used, displayed or provided on or in connection with the Technology, including all intellectual property rights therein and thereto, whether or not subject to the open-source licenses, and hereby grant you a limited, non-exclusive, revocable, non-transferable, non-sublicensable license to access and use those portions of the Technology that are proprietary and not available pursuant to the open-source licenses.    
...
• Polygon zkEVM blockchain assets associated with your Wallet address;    
